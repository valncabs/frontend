(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SimpleDatatables = {}));
    ...
    /* src\components\SearchInputHTML.svelte generated by Svelte v3.55.1 */
    ...
    /* src\SearchInput.svelte generated by Svelte v3.55.1 */
    ...
    /* src\components\PaginationRowCountHTML.svelte generated by Svelte v3.55.1 */
    ...
    /* src\PaginationRowCount.svelte generated by Svelte v3.55.1 */
    ...
    /* src\components\PaginationButtonsHTML.svelte generated by Svelte v3.55.1 */
    ...
    /* src\PaginationButtons.svelte generated by Svelte v3.55.1 */
    ...
    /* src\components\StickyHeader.svelte generated by Svelte v3.55.1 */

    function add_css$2(target) {
    	append_styles(target, "svelte-m8h5vn", "thead.svelte-m8h5vn.svelte-m8h5vn{position:sticky;inset-block-start:0}.css.svelte-m8h5vn th.svelte-m8h5vn{padding:8px 0px 8px 16px;text-align:center;border-bottom:1px solid #eee;background:#fff;user-select:none}.css.svelte-m8h5vn th.sortable.svelte-m8h5vn{cursor:pointer}.css.svelte-m8h5vn th.sortable span.svelte-m8h5vn{padding-right:16px;position:relative}.css.svelte-m8h5vn th.sortable span.svelte-m8h5vn:before,.css.svelte-m8h5vn th.sortable span.svelte-m8h5vn:after{border:4px solid transparent;content:'';display:block;height:0;right:0;top:50%;position:absolute;width:0}.css.svelte-m8h5vn th.sortable span.svelte-m8h5vn:before{border-bottom-color:#e0e0e0;margin-top:-9px}.css.svelte-m8h5vn th.sortable span.svelte-m8h5vn:after{border-top-color:#e0e0e0;margin-top:1px}.css.svelte-m8h5vn th.sortable.asc span.svelte-m8h5vn:before{border-bottom-color:#9e9e9e}.css.svelte-m8h5vn th.sortable.desc span.svelte-m8h5vn:after{border-top-color:#9e9e9e}.css.svelte-m8h5vn th.filter.svelte-m8h5vn{padding:0;margin:0;background-image:none;border:1px solid #fafafa}th.filter.svelte-m8h5vn input.svelte-m8h5vn{margin:0;padding:0;width:100%}.css.svelte-m8h5vn th.filter input.svelte-m8h5vn{background:#fff;height:24px;border:none;border-bottom:1px solid #eee;text-align:center;outline:none;border-radius:0;font-size:14px}.css.svelte-m8h5vn th.filter input.svelte-m8h5vn::placeholder{color:#bdbdbd;font-style:italic;font-size:13px}");
    }
    ...
    function create_each_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			t = space();
    			html_tag.a = span;
    			attr(span, "class", "svelte-m8h5vn");
    			attr(th, "nowrap", "");
    			attr(th, "class", th_class_value = "" + (null_to_empty(/*th*/ ctx[8].classList) + " svelte-m8h5vn"));
    ...
    function create_if_block_1$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(input, "class", "browser-default svelte-m8h5vn");
    		},
    		m(target, anchor) {
    			insert(target, input, anchor);
    ...
    function create_each_block$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			if (if_block) if_block.c();
    			t = space();
    			attr(th, "class", "filter svelte-m8h5vn");
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			t = space();
    			if (if_block) if_block.c();
    			attr(thead, "class", thead_class_value = "dt-header " + /*theadClassList*/ ctx[2] + " svelte-m8h5vn");
    ...
    /* src\Datatable.svelte generated by Svelte v3.55.1 */

    function add_css$1(target) {
    	append_styles(target, "svelte-15iwbfd", ".datatable.svelte-15iwbfd.svelte-15iwbfd{position:relative}.css.datatable.svelte-15iwbfd.svelte-15iwbfd{background:#fff}.datatable.scroll-y.svelte-15iwbfd.svelte-15iwbfd{height:160px}.datatable.svelte-15iwbfd .svelte-15iwbfd{box-sizing:border-box}article.svelte-15iwbfd.svelte-15iwbfd{position:relative;height:calc(100% - 96px);overflow:auto;background:inherit}table.svelte-15iwbfd.svelte-15iwbfd{width:100%;border-collapse:separate;border-spacing:0}table.svelte-15iwbfd tbody{padding-top:26px}.css.svelte-15iwbfd article.svelte-15iwbfd{border-bottom:1px solid #e0e0e0;scrollbar-width:thin}.css.svelte-15iwbfd article.svelte-15iwbfd::-webkit-scrollbar{width:6px;height:6px}.css.svelte-15iwbfd article.svelte-15iwbfd::-webkit-scrollbar-track{background:#f5f5f5}.css.svelte-15iwbfd article.svelte-15iwbfd::-webkit-scrollbar-thumb{background:#c2c2c2}.css.svelte-15iwbfd article.svelte-15iwbfd::-webkit-scrollbar-thumb:hover{background:#9e9e9e}.css.svelte-15iwbfd article.svelte-15iwbfd::-webkit-scrollbar-track-piece:start{top:40px}.css.svelte-15iwbfd table.svelte-15iwbfd{margin-bottom:6px}");
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			t2 = space();
    			if (if_block2) if_block2.c();
    			attr(table, "class", "svelte-15iwbfd");
    			toggle_class(table, "with-filter", /*options*/ ctx[4].columnFilter);
    			attr(article, "class", "dt-table svelte-15iwbfd");
    			attr(section, "id", /*id*/ ctx[1]);
    			attr(section, "class", section_class_value = "datatable " + /*classList*/ ctx[0] + " svelte-15iwbfd");
    ...
    /* src\ColumnFilterInputs.svelte generated by Svelte v3.55.1 */
    ...
    exports.ColumnFilterInputs = ColumnFilterInputs;
    exports.Datatable = Datatable_1;
    exports.PaginationButtons = PaginationButtons;
    exports.PaginationRowCount = PaginationRowCount;
